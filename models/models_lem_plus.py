...
__all__ = [
    'lem_plus_base_patch16',
    'lem_plus_large_patch16',
    'lem_plus_huge_patch14'
]
...
class LocalityEnhancedModule(timm.models.vision_transformer.VisionTransformer):
    ...
    def __init__(self, global_pool=False, **kwargs):
        ...
        self.conv_head = nn.Sequential(
            BasicBlock(in_plane, in_plane * 2, stride=2, downsample=downsample_conv(in_plane, in_plane * 2, kernel_size=1, stride=2)),
            BasicBlock(in_plane * 2, in_plane * 2, stride=1)
        )
...
def lem_plus_base_patch16(cfg, num_classes):
...
def lem_plus_large_patch16(cfg, num_classes):
    model = LocalityEnhancedModule(img_size=cfg.INPUT.IMAGE_SIZE, num_classes=num_classes,
...
def lem_plus_huge_patch14(cfg, num_classes):
    model = LocalityEnhancedModule(img_size=cfg.INPUT.IMAGE_SIZE, num_classes=num_classes,
