...
class Market1501(Dataset):
    def __init__(self, cfg, transform, is_train):
        ...
        train_dir = os.path.join(cfg.DATASET.ROOT_DIR, "bounding_box_train")
        query_dir = os.path.join(cfg.DATASET.ROOT_DIR, 'query')
        gallery_dir = os.path.join(cfg.DATASET.ROOT_DIR, 'bounding_box_test')
